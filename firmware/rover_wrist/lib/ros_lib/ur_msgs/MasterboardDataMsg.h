...
namespace ur_msgs
{
  ...
  class MasterboardDataMsg : public ros::Msg
  {
    public:
      ...
      typedef float _analog_input0_type;
      _analog_input0_type analog_input0;
      typedef float _analog_input1_type;
      ...
      typedef float _analog_output0_type;
      _analog_output0_type analog_output0;
      typedef float _analog_output1_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 1) = (this->digital_input_bits >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->digital_input_bits >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->digital_input_bits >> (8 * 3)) & 0xFF;
      offset += sizeof(this->digital_input_bits);
      *(outbuffer + offset + 0) = (this->digital_output_bits >> (8 * 0)) & 0xFF;
      *(outbuffer + offset + 1) = (this->digital_output_bits >> (8 * 1)) & 0xFF;
      *(outbuffer + offset + 2) = (this->digital_output_bits >> (8 * 2)) & 0xFF;
      *(outbuffer + offset + 3) = (this->digital_output_bits >> (8 * 3)) & 0xFF;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      this->digital_input_bits |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->digital_input_bits |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->digital_input_bits |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      offset += sizeof(this->digital_input_bits);
      this->digital_output_bits =  ((uint32_t) (*(inbuffer + offset)));
      this->digital_output_bits |= ((uint32_t) (*(inbuffer + offset + 1))) << (8 * 1);
      this->digital_output_bits |= ((uint32_t) (*(inbuffer + offset + 2))) << (8 * 2);
      this->digital_output_bits |= ((uint32_t) (*(inbuffer + offset + 3))) << (8 * 3);
      offset += sizeof(this->digital_output_bits);
      union {
        int8_t real;
        uint8_t base;
